        ...
        <div className="web-page">
            <div className="web-section all-blogs web-section-content" id="all-blogs">
                <div className="web-section__container all-blogs__container">
                    ...
                    <AllBlogsItem title="Choosing the Right Sponsor" body="Navigate the maze of potential sponsors to select the ideal partner for your podcast. Align your content and revenue goals with suitable sponsorships." link="/blogs/reaching-out" />
                    <AllBlogsItem title="Crafting an Effective Sponsorship Pitch" body="Discover the art of reaching out for podcast sponsorships. Learn the cornerstone strategies for successful partnerships." link="/blogs/reaching-out" />
                </div>
            </div>
        </div>
    );
